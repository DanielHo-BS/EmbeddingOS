...
void  OSCtxSw (void)
{
    ...
    if (OSPrioHighRdy == 63) {
        if (OSPrioCur == TaskParameter[0].TaskPriority) {
            printf("%2d\ttask(%2d)(%2d)\ttask(%2d)    \tOSCtxSW ()\n", OSTime, TaskParameter[0].TaskID, TaskCtr[0], OSPrioHighRdy);
            if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0)
            {
                fprintf(Output_fp,"%2d\ttask(%2d)(%2d)\ttask(%2d)    \tOSCtxSW ()\n", OSTime, TaskParameter[0].TaskID, TaskCtr[0], OSPrioHighRdy);
                fclose(Output_fp);
            }
            TaskCtr[0]++;
        }
        else if (OSPrioCur == TaskParameter[1].TaskPriority) {
    ...
    else if (OSPrioHighRdy == TaskParameter[0].TaskPriority){
        printf("%2d\ttask(%2d)(%2d)\ttask(%2d)(%2d)\tOSCtxSW ()\n", OSTime, TaskParameter[1].TaskID, TaskCtr[1], TaskParameter[0].TaskID, TaskCtr[0]);
        if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0)
        {
            fprintf(Output_fp, "%2d\ttask(%2d)(%2d)\ttask(%2d)(%2d)\tOSCtxSW ()\n", OSTime, TaskParameter[1].TaskID, TaskCtr[1], TaskParameter[0].TaskID, TaskCtr[0]);
            fclose(Output_fp);
        }
        TaskCtr[1]++;
    }
    else if (OSPrioHighRdy == TaskParameter[1].TaskPriority) {
...
void  OSIntCtxSw (void)
{
    ...
    OSTCBCur  = OSTCBHighRdy;
    if (OSPrioHighRdy == TaskParameter[0].TaskPriority) {
        printf("%2d\ttask(%2d)    \ttask(%2d)(%2d)\tOSIntCtxSw ()\n", OSTime, OSPrioCur, TaskParameter[0].TaskID, TaskCtr[0]);
        if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0)
        {
            fprintf(Output_fp, "%2d\ttask(%2d)    \ttask(%2d)(%2d)\tOSIntCtxSw ()\n", OSTime, OSPrioCur, TaskParameter[0].TaskID, TaskCtr[0]);
            fclose(Output_fp);
        }
    }
    else if (OSPrioHighRdy == TaskParameter[1].TaskPriority) {
