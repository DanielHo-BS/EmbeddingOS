...
void InputFile() {
    ...
    {
        /// printf("The file 'TaskSet.txt' was opend\n");
    }
    else
    {
        printf("The file 'TaskSet.txt' was not opend\n");
    }
    ...
    SERVER_ID = TaskParameter[j - 1].TaskID;
    SERVER_SIZE = TaskParameter[j - 1].TaskArriveTime;
    fclose(fp);
}
...
void InputAperiodicFile() {
    ...
    {
        /// printf("The file 'Aperiodicjobs.txt' was opend\n");
    }
    else
    {
        printf("The file 'AperiodicJobs.txt' was not opend\n");
    }
    ...
    while (!feof(fp))
    {
        ...
        while (ptr != NULL)
        {
            ...
            /// printf("Info: %d\n", TaskInfo[i]);
            if (i == 0) {
                AperiodicJobParameter[j].TaskID = TaskInfo[i];
            }
            else if (i == 1)
                AperiodicJobParameter[j].TaskArriveTime = TaskInfo[i];
            else if (i == 2)
                AperiodicJobParameter[j].TaskExecutionTime = TaskInfo[i];
            else if (i == 3)
                AperiodicJobParameter[j].AbsoluteDeadline = TaskInfo[i];
