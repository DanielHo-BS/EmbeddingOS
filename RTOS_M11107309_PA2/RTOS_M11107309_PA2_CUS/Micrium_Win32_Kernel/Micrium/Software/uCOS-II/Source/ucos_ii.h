...
int TASK_NUMBER; /// input tasks �ƶq
int SERVER_ID; /// PA#2�A���wCUS��task ID
int SERVER_PRIO;
int SERVER_SIZE;
/// Task��Ƶ��c
...
INT8U         OS_TCBInit              (INT8U            prio,
                                       ...
                                       void            *pext,
                                       INT16U           opt,
                                       INT8U arrive_time, INT8U exe_time, INT8U deadline);
